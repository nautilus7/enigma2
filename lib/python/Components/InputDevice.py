...
class InitInputDevices:
	...
	def setupConfigEntries(self, device):
		...
		configItem.enabled = ConfigYesNo(default=False)
		...
		configItem.repeat = ConfigSelectionNumber(default=100, min=0, max=500, stepwidth=10)
		configItem.repeat.addNotifier(self.inputDevicesRepeatChanged)
		configItem.delay = ConfigSelectionNumber(default=700, min=0, max=5000, stepwidth=100)
