...
def runScreen():
	...
	screensToRun = [x.fnc for x in plugins.getPlugins(PluginDescriptor.WHERE_WIZARD)]
	profile("InitWizards")
...
from Components.International import international #  this must be imported before config
